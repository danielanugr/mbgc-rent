...
After 10 rounds or as soon as a player reaches the maximum population limit, the leader of the best city in the ancient world will be the winner of World Wonders!`,
      images: [
        '/images/sample-products/ww-1.jpg',
        '/images/sample-products/ww-2.png',
      ],
      price: 75000,
    ...
    },
    {
      ...
      images: [
        '/images/sample-products/heat-1.jpg',
        '/images/sample-products/heat-2.jpeg',
      ],
      price: 75000,
    ...
    },
    {
      ...
      images: [
        '/images/sample-products/clank-1.webp',
        '/images/sample-products/clank-2.webp',
      ],
      price: 75000,
      brand: 'Dire Wolf Games',
      rating: 4.9,
      numReviews: 3,
      stock: 1,
      isFeatured: true,
